...
def main() -> None:
    ...
    parser.add_argument("input", nargs="?", default="yaratik_isimleri.txt", help="Girdi dosyası")
    parser.add_argument("output", nargs="?", default="temiz_yaratik_isimleri.txt", help="Çıktı dosyası")
